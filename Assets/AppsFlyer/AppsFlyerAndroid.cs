...
namespace AppsFlyerSDK
{
    ...
    public class AppsFlyerAndroid
    {
        ...
        /// However, apps with Google playButton services should avoid Android ID collection as this is in violation of the Google Play policy.
        /// </summary>
        ...
        /// However, apps with Google playButton services should avoid IMEI collection as this is in violation of the Google Play policy.
        /// </summary>
        /// <param name="isCollect">boolean, false to opt-out.</param>
